...
"""
  CLI interface for sgs management.
"""
...
class ConfigCommands(object):
    ...
    def list(self, param=None):
        """List parameters configured for sgs.

        Lists all parameters configured for sgservice unless an optional
        argument is specified.  If the parameter is specified we only print
        the requested parameter.  If the parameter is not found an appropriate
