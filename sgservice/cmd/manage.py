...
class ConfigCommands(object):
    ...
    def list(self, param=None):
        ...
        Lists all parameters configured for sgs unless an optional argument
...
class ServiceCommands(object):
    ...
    def list(self):
        """Show a list of all sgs services."""
...
def main():
    ...
    try:
        CONF(sys.argv[1:], project='sgs',
             version=version.version_string())
        logging.setup(CONF, "sgs")
        ...
        print(_('Please re-run sgs-manage as root.'))
        sys.exit(2)
