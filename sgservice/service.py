...
from sgservice.i18n import _, _LE, _LI, _LW
...
from sgservice.wsgi import eventlet_server as wsgi
...
service_opts = [
    ...
    cfg.StrOpt('osapi_sgservice_listen',
               default="0.0.0.0",
               help='IP address on which SGService API listens'),
    cfg.PortOpt('osapi_sgservice_listen_port',
                default=8975,
                help='Port on which SGService API listens'),
    cfg.IntOpt('osapi_sgservice_workers',
               help='Number of workers for SGService API service. '
...
class Service(service.Service):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'sgservice-' part
        ...
        if not topic:
            topic = binary
        if not manager:
            subtopic = topic.rpartition('sgservice-')[2]
