...
import grpc.volume_control_pb2 as control__api_dot_volume__control__pb2
...
class VolumeControlStub(object):
  ...
  def __init__(self, channel):
    ...
    self.UpdateVolumeStatus = channel.unary_unary(
        '/huawei.proto.control.VolumeControl/UpdateVolumeStatus',
        request_serializer=control__api_dot_volume__control__pb2.UpdateVolumeStatusReq.SerializeToString,
        response_deserializer=control__api_dot_volume__control__pb2.UpdateVolumeStatusRes.FromString,
        )
...
class VolumeControlServicer(object):
  ...
  def UpdateVolumeStatus(self, request, context):
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
    raise NotImplementedError('Method not implemented!')
...
def add_VolumeControlServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'UpdateVolumeStatus': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateVolumeStatus,
          request_deserializer=control__api_dot_volume__control__pb2.UpdateVolumeStatusReq.FromString,
          response_serializer=control__api_dot_volume__control__pb2.UpdateVolumeStatusRes.SerializeToString,
      ),
