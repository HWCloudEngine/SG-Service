...
class API(base.Base):
    ...
    def enable_sg(self, context, volume_id, name=None, description=None):
        ...
        if volume is not None:
            volume.update(volume_properties)
        else:
    ...
    def disable_sg(self, context, volume, cascade=False):
        ...
        # TODO(luobin): classify local-backup and remote-backup
        backups = objects.BackupList.get_all_for_volume(context, volume.id)
