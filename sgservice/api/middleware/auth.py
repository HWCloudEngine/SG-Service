...
from sgservice.wsgi import common as base_wsgi
...
class InjectContext(base_wsgi.Middleware):
    """Add a 'sgservice.context' to WSGI environ."""
    ...
    def __call__(self, req):
        req.environ['sgservice.context'] = self.context
        return self.application


class SGServiceKeystoneContext(base_wsgi.Middleware):
...
class NoAuthMiddleware(base_wsgi.Middleware):
    ...
    def __call__(self, req):
        ...
        req.environ['sgservice.context'] = ctx
        return self.application
