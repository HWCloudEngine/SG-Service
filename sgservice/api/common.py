...
def remove_version_from_href(href):
    ...
    Given: 'http://www.sgservice.com/v1.1/123'
    Returns: 'http://www.sgservice.com/123'

    Given: 'http://www.sgservice.com/v1.1'
    Returns: 'http://www.sgservice.com'
...
class ViewBuilder(object):
    ...
    def _get_next_link(self, request, identifier, collection_name):
        ...
        url = os.path.join(prefix,
                           request.environ["sgservice.context"].project_id,
                           collection_name)
